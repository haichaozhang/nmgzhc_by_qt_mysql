...
CREATE TABLE IF NOT EXISTS `TheSQD`.`TheEnvironmentMessage` (
  ...
  `TheEnvironmentelectricity` VARCHAR(45) NULL COMMENT '设备监控电流',
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `TheSQD`.`Workshopmonitoring` (`"TheEquipmentID_view"` INT, `"TheEquipmentName_view"` INT, `"TheEnvironmentDaytime_view"` INT, `"TheWorkerRFID_view"` INT, `"TheWorkerName_view"` INT, `"TheEnvironmentTemperature_view"` INT, `"TheEnvironmentHnmidity_view"` INT, `"TheEnvironmentelectricity_view"` INT, `"TheEnvironmentNumber_view"` INT);
...
CREATE PROCEDURE `TheSQD`.`enviromentiformation` (EquipmentID  Varchar(45),WorkerRFID Varchar(45),Temperature Varchar(45),Hnmidity Varchar(45),Electricity Varchar(45),Number Varchar(45))
MODIFIES SQL DATA
BEGIN
    insert into TheSQD.TheEnvironmentMessage(TheEnvironmentDaytime,TheEnvironmentEquipmentID ,TheEnvironmentWorkerRFID,TheEnvironmentTemperature,TheEnvironmentHnmidity,TheEnvironmentelectricity,TheEnvironmentNumber)
    values (Now(),EquipmentID,WorkerRFID,Temperature,Hnmidity,Electricity,Number)
    ;
END
...
select TheEquipmentMessage.TheEquipmentID as "TheEquipmentID_view",
        ...
        TheEnvironmentMessage.TheEnvironmentelectricity as "TheEnvironmentelectricity_view",
