...
CREATE TABLE IF NOT EXISTS `TheSQD`.`TheEquipmentMessage` (
  ...
  INDEX `Workshop_idx` (`TheEquipmentWorkshop` ASC),
...
CREATE TABLE IF NOT EXISTS `TheSQD`.`TheProductionMessage` (
  ...
  INDEX `WorkerRFID_idx` (`ThrProductionWorkerRFID` ASC),
  INDEX `EquipmentID_idx` (`ThrProductionEquipmentID` ASC),
...
CREATE TABLE IF NOT EXISTS `TheSQD`.`TheEnvironmentMessage` (
  ...
  INDEX `EnEquipmentID_idx` (`TheEnvironmentEquipmentID` ASC),
  INDEX `EnWorkerRFID_idx` (`TheEnvironmentWorkerRFID` ASC),
...
-- -----------------------------------------------------
-- Table `TheSQD`.`serialporttest`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `TheSQD`.`serialporttest` (
  `idserialtest` INT NOT NULL COMMENT '测试数据库编码\n',
  `ThetestDaytime` DATETIME NULL COMMENT '时间\n',
  `ThrtestEquipmentID` VARCHAR(45) NULL COMMENT '设备编号\n',
  `Thrtestmessage1` VARCHAR(45) NULL COMMENT '设备信息1\n\n',
  `Thrtestmessage2` VARCHAR(45) NULL COMMENT '设备信息2',
  `Thrtestmessage3` VARCHAR(45) NULL COMMENT '设备信息3',
  `Thrtestmessage4` VARCHAR(45) NULL COMMENT '设备信息4',
  `Thrtestmessage5` VARCHAR(45) NULL COMMENT '设备信息5',
  `Thrtestmessage6` VARCHAR(45) NULL COMMENT '设备信息6',
  PRIMARY KEY (`idserialtest`))
ENGINE = InnoDB
COMMENT = '测试用信息记录表';
...
DELIMITER $$
USE `TheSQD`$$
CREATE PROCEDURE `TheSQD`.`serialtest`(testEquipmentID  Varchar(45),testmessage1 Varchar(45),testmessage2 Varchar(45),testmessage3 Varchar(45),testmessage4 Varchar(45),testmessage5 Varchar(45),testmessage6 Varchar(45))
MODIFIES SQL DATA
BEGIN
	insert into TheSQD.serialporttest(ThetestDaytime,ThrtestEquipmentID,Thrtestmessage1,Thrtestmessage2,Thrtestmessage3,Thrtestmessage4,Thrtestmessage5,Thrtestmessage6)
    value(now(),testEquipmentID,testmessage1,testmessage2,testmessage3,testmessage4,testmessage5,testmessage6)
    ;
END
$$
